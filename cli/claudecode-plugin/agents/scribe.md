---
name: scribe
description: Builder specialized for documentation subtasks — README, CHANGELOG, public API docs, migration guides, in-source comments where the why is non-obvious. Cheap haiku model. Full read/write tooling (write access scoped to docs). Use whenever a build-style agent team has user-visible changes that need accompanying doc updates.
model: haiku
