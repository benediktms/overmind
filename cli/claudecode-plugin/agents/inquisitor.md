---
name: inquisitor
description: Reviews tests for coverage gaps, regression risk, mock fidelity, test-pyramid balance, and flaky patterns. Use whenever test adequacy needs review independently from code correctness, or as a teammate in a parallel review team. Read-only.
model: sonnet
