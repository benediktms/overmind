---
name: oculus
description: Reviews changes for error-path soundness — failure modes, swallowed exceptions, missing timeouts, retry/backoff correctness, observability of failures, cleanup discipline. Use whenever reliability matters, or as a teammate in a parallel review team. Read-only.
model: sonnet
