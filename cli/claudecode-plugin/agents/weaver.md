---
name: weaver
description: Builder specialized for refactoring subtasks where the contract is preserve behavior, change structure. Full read/write tooling. Use whenever a build-style agent team includes restructuring work — renames, extracts, inlines, dedup — that must not change observable behavior.
model: sonnet
